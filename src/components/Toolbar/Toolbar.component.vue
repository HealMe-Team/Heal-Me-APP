  ...
  <div>
    <nav class="toolbar">
      <div v-if="isDoctorView">
        <router-link to="/doctor-view" class="toolbar-link" @mouseover="highlight" @mouseout="unhighlight">Scheduled Appointments</router-link>
        <router-link to="/doctor-view/history" class="toolbar-link" @mouseover="highlight" @mouseout="unhighlight">Appointment History</router-link>
      </div>
      <div v-else>
        <router-link to="/doctor" class="toolbar-link" @mouseover="highlight" @mouseout="unhighlight">Doctors</router-link>
        <a href="#" class="toolbar-link" @click.prevent="showModal = true" @mouseover="highlight" @mouseout="unhighlight">Appointment</a>
        <router-link to="/hospitals" class="toolbar-link" @mouseover="highlight" @mouseout="unhighlight">Hospitals/Clinics</router-link>
        <router-link to="/products" class="toolbar-link" @mouseover="highlight" @mouseout="unhighlight">Recommended products</router-link>
      </div>
    </nav>
...
export default {
  ...
  computed: {
    isDoctorView() {
      ...
      return this.$route.path === '/doctor-view' || this.$route.path === '/doctor-view/history';
    }
  },
  methods: {
    highlight(event) {
